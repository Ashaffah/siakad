...
<div class="page-breadcrumb">
			...
			<div class="container-fluid">
                ...
                <div class="row">
				 ...
				 <?php
            echo form_open_multipart('fuzzy/edit', 'role="form" class="form-horizontal"');
            ?>
 ...
 <div class="row">
                    <div class="col-12">
						...
						$jumdat = $this->db->from('fuzzy')->get()->num_rows(); //untuk mengamill jumlah data pada tabel fuzzy ?>
...
<!-- MODAL ADD -->
        <div class="modal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <?php
            echo form_open_multipart('fuzzy/add', 'role="form" class="form-horizontal"');
            ?>
...
function tabel(){
 $.ajax({
                type  : 'GET',
                url   : '<?php echo base_url()?>fuzzy/grafik/',
                async : true,
                dataType : 'json',
