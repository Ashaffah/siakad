...
<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Nilai</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Nilai</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
			...
			<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
					<h4 class="card-title">Rule Nilai</h4>
				 <?php
            echo form_open_multipart('nilai/edit', 'role="form" class="form-horizontal"');
            ?>
 ...
 <div class="row">
                    <div class="col-12">
						...
						$jumdat = $this->db->from('nilai')->get()->num_rows(); //untuk mengamill jumlah data pada tabel fuzzy ?>
...
<div class="row">
		...
		$hasilmid += ($u->nilai-$min)/30;
		} else if ($mid <= $u->nilai && $u->nilai <= $max){
		$hasilmid += ($max - $u->nilai)/30;
		} else {
		$hasilmid += 0;
		}
...
<!-- MODAL ADD -->
        <div class="modal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <?php
            echo form_open_multipart('nilai/add', 'role="form" class="form-horizontal"');
            ?>
...
function tabel(){
 $.ajax({
                type  : 'GET',
                url   : '<?php echo base_url()?>nilai/grafik/',
                async : true,
                dataType : 'json',
