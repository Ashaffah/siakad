<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Mahasiswa</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Mahasiswa</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <form>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="data1" id="data1" class="form-control" type="text" placeholder="NAMA">
                        </div>
                    </div>
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="data2" id="data2" class="form-control" type="text" placeholder="NIM">
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="data3" id="data3" class="form-control" type="text" placeholder="KELAS">
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function tampil_data_barang(){
            $.ajax({
                type  : 'GET',
                url   : '<?php echo base_url()?>mahasiswa/data_data',
                async : true,
                dataType : 'json',
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : 'GET',
                url  : '<?php echo base_url('mahasiswa/get_data')?>',
                dataType : 'JSON',
                data : {id:id},
                success: function(data){
...
$('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('mahasiswa/add')?>",
                dataType : "JSON",
